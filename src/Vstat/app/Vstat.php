...
Class Vstat
{
    ...
    public function showByType($type = 'PILOT') : array
    {
        if ($type === 'PILOT') {
            ...
            return array_values(array_filter($this->getClients(), array($this->dataFilter, 'filterByPilot')));
        }
        return  array_values(array_filter($this->getClients(), array($this->dataFilter, 'filterByAtc')));
    }
    ...
    public function showByAirline($icao = 'DLH') : array
    {
        ...
        return  array_values(array_filter($this->getClients(), array($this->dataFilter, 'filterByAirline')));
    }
    ...
    public function showByCallsign($callsign = null) : array
    {
        ...
        return array_values(array_filter($this->getClients(), array($this->dataFilter, 'filterbyCallSign')));
    }    
    ...
    public function showByVatsimId($cid = null) : array
    {
        ...
        return array_values(array_filter($this->getClients(), array($this->dataFilter, 'filterbyId')));
    }
